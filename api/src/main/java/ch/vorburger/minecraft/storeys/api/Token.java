...
public class Token {
    ...
    private String loginCode;    // this is our "old" ch.vorburger.minecraft.storeys.simple.Token
    private String playerSource; // this is our "new" CommandSource as Player cause; currently a Player UUID, later TODO encrypted
